...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [RuleCriteria("PMScheduleEqComponentsDeleteRule", DefaultContexts.Delete, "1=0", "Cannot Delete.")]
    //[RuleCriteria("WorkOrderEqComponentsEqSaveRule", DefaultContexts.Save, "ValidDate", "Date From and Date To is not valid.")]
    public class PMScheduleEqComponents : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public PMScheduleEqComponents()
        {
        ...
        public virtual PMScheduleEquipments PMScheduleEquipment { get; set; }
