...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [XafDisplayName("Deviation Frequency")]
    ...
    public class DeviationFrequencies : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public DeviationFrequencies()
        {
