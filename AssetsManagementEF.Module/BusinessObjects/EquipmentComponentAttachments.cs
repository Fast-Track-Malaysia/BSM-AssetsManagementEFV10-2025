...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [XafDisplayName("Component Attachment")]
    ...
    public class EquipmentComponentAttachments : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public EquipmentComponentAttachments()
        {
        ...
        [Browsable(false)]
        public virtual EquipmentComponents EquipmentComponent { get; set; }
