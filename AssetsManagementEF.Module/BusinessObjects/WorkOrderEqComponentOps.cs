...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [XafDisplayName("Com Operation Logs")]
    [RuleCriteria("WorkOrderEqComponentOpsDeleteRule", DefaultContexts.Delete, "1=0", "Cannot Delete.")]
    [RuleCriteria("WorkOrderEqComponentOpsEqSaveRule", DefaultContexts.Save, "ValidDate", "Date From and Date To is not valid.")]
    // Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    public class WorkOrderEqComponentOps : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public WorkOrderEqComponentOps()
        {
        ...
        //[DataSourceCriteria("not IsUp and not IsDown")]
        ...
        //[RuleRequiredField(DefaultContexts.Save, TargetCriteria = "Done")]
        ...
        public virtual WorkOrderEqComponents WorkOrderEqComponent { get; set; }
        ...
        void IXafEntityObject.OnSaving()
        {
            ...
            CpDownTime = DateTime.Parse("2099-12-31");
            if (FDate != null)
                if (WorkOrderOpType.IsDown && IsDone && !IsCancel)
                    CpDownTime = (DateTime)FDate;

            CpUpTime = DateTime.Parse("1900-01-01");
            if (TDate != null)
                if (WorkOrderOpType.IsUp && IsDone && !IsCancel)
                    CpUpTime = (DateTime)TDate;
