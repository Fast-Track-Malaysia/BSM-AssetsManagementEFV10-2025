...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    public class EqComponentClassDocs : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public EqComponentClassDocs()
        {
        ...
        [Appearance("EqComponentClass", Enabled = false)]
        public virtual EqComponentClasses EqComponentClass { get; set; }
