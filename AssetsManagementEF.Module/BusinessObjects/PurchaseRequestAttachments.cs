...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [XafDisplayName("Purchase Request Attachment")]
    ...
    public class PurchaseRequestAttachments : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public PurchaseRequestAttachments()
        {
