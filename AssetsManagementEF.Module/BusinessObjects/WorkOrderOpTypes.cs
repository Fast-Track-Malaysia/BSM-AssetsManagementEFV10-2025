...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [XafDisplayName("Operation Type")]
    //[ImageName("BO_Contact")]
    //[DefaultProperty("Name")]
    //[DefaultListViewOptions(MasterDetailMode.ListViewOnly, false, NewItemRowPosition.None)]
    // Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    public class WorkOrderOpTypes : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public WorkOrderOpTypes()
        {
        ...
        [XafDisplayName("Operation Code"), ToolTip("Enter Text")]
        [RuleUniqueValue]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        ...
        [XafDisplayName("Operation Name"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleRequiredField(DefaultContexts.Save)]
