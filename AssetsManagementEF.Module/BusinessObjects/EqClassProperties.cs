...
{
    // Register this entity in the DbContext using the "public DbSet<ClassProperties> ClassPropertiess { get; set; }" syntax.
    [DefaultClassOptions]
    [NavigationItem("Equipment Setup")]
    //[ImageName("BO_Contact")]
    [XafDisplayName("Class Properties")]
    ...
    public class EqClassProperties : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public EqClassProperties()
        {
            // In the constructor, initialize collection properties, e.g.: 
            // this.AssociatedEntities = new List<AssociatedEntityObject>();
            this.EqClass = new List<EqClasses>();
        }
        ...
        [XafDisplayName("Property Code"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleUniqueValue]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        [XafDisplayName("Property Name"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        public virtual IList<EqClasses> EqClass { get; set; }
