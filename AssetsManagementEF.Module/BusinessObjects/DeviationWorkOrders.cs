...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [XafDisplayName("Work Order Deviation")]
    ...
    public class DeviationWorkOrders : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public DeviationWorkOrders()
        {
