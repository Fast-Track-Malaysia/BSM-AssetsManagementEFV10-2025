...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [XafDisplayName("Equipment Classes")]
    ...
    public class EqClasses : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public EqClasses()
        {
            // In the constructor, initialize collection properties, e.g.: 
            // this.AssociatedEntities = new List<AssociatedEntityObject>();
            this.EqClassProperty = new List<EqClassProperties>();
        }
        ...
        [XafDisplayName("Class Code"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleUniqueValue]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        [XafDisplayName("Class Name"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        [XafDisplayName("Group"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        //[RuleRequiredField(DefaultContexts.Save)]
        [Browsable(false)]
        ...
        public virtual IList<EqClassProperties> EqClassProperty { get; set; }
