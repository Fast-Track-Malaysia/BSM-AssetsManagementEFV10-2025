...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    public class PMClassDocs : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public PMClassDocs()
        {
        ...
        [Appearance("PMClasses", Enabled = false)]
        public virtual PMClasses PMClass { get; set; }
