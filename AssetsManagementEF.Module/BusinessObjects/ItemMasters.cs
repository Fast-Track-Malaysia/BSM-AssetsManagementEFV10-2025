...
{
    // Register this entity in the DbContext using the "public DbSet<ItemMasters> ItemMasterss { get; set; }" syntax.
    [DefaultClassOptions]
    ...
    public class ItemMasters : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public ItemMasters()
        {
