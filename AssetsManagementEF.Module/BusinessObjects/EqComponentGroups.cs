...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [XafDisplayName("Component Group")]
    ...
    public class EqComponentGroups : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public EqComponentGroups()
        {
        ...
        [XafDisplayName("Group Code"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleUniqueValue]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        [XafDisplayName("Group Name"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleRequiredField(DefaultContexts.Save)]
