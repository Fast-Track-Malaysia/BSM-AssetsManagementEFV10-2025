...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    public class Locations : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public Locations()
        {
        ...
        [XafDisplayName("Location Code"), ToolTip("Enter Text")]
        [RuleUniqueValue]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        [XafDisplayName("Location Name"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleRequiredField(DefaultContexts.Save)]
