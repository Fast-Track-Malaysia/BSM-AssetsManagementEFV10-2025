...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [RuleCriteria("PurchaseRequestDocStatusesDeleteRule", DefaultContexts.Delete, "1=0", "Cannot Delete.")]
    //[RuleCriteria("WorkOrderEquipmentsEqSaveRule", DefaultContexts.Save, "ValidDate", "Date From and Date To is not valid.")]
    public class PurchaseRequestDocStatuses : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public PurchaseRequestDocStatuses()
        {
