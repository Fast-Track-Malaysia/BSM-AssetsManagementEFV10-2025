...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [XafDisplayName("PM Batches")]
    //[ImageName("BO_Contact")]
    [DefaultProperty("BoCode")]
    [RuleCriteria("PMPatchesDeleteRule", DefaultContexts.Delete, "1=0", "Cannot Delete.")]
    //[DefaultListViewOptions(MasterDetailMode.ListViewOnly, false, NewItemRowPosition.None)]
    // Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    public class PMPatches : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public PMPatches()
        {
            // In the constructor, initialize collection properties, e.g.: 
            this.DetailWorkOrder = new List<WorkOrders>();
        }
        ...
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [Index(300), VisibleInListView(true), VisibleInDetailView(true), VisibleInLookupListView(false)]
        ...
        [XafDisplayName("Batch Code"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        ...
        [XafDisplayName("Batch Name"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        ...
        [XafDisplayName("Work Order List")]
        [Appearance("DetailWorkOrder", Enabled = false)]
        public virtual IList<WorkOrders> DetailWorkOrder { get; set; }
