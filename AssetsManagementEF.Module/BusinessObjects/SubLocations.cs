...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    public class SubLocations : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public SubLocations()
        {
        ...
        [XafDisplayName("Sub Location Code"), ToolTip("Enter Text")]
        [RuleUniqueValue]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        [XafDisplayName("Sub Location Name"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleRequiredField(DefaultContexts.Save)]
