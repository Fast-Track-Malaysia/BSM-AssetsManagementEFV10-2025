...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    public class Areas : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public Areas()
        {
        ...
        [XafDisplayName("Area Code"), ToolTip("Enter Text")]
        [RuleUniqueValue]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        ...
        [XafDisplayName("Area Name"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleRequiredField(DefaultContexts.Save)]
