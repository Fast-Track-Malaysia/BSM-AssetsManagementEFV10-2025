...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    public class PlannerGroups : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public PlannerGroups()
        {
            // In the constructor, initialize collection properties, e.g.: 
            this.PMClass = new List<PMClasses>();
            this.DetailPosition = new List<Positions>();
        }
        ...
        [XafDisplayName("Position List")]
        //[Appearance("DetailPosition", Enabled = false)]
        public virtual IList<Positions> DetailPosition { get; set; }
