...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [XafDisplayName("Component Photo")]
    ...
    public class EquipmentComponentPhotos : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public EquipmentComponentPhotos()
        {
