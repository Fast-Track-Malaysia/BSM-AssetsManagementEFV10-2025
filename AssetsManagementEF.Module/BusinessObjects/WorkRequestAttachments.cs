...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [XafDisplayName("Work Request Attachment")]
    ...
    public class WorkRequestAttachments : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public WorkRequestAttachments()
        {
