...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    public class JobStatuses : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public JobStatuses()
        {
        ...
        [XafDisplayName("Job Code"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleUniqueValue]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        [XafDisplayName("Job Name"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        [XafDisplayName("Planning Job"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        public bool IsPlanning
        {
            ...
            set
            {
                ...
                {
                    _IsPlanning = value;
                    OnPropertyChanged("IsPlanning");
                }
            }
        }

        private bool _IsPreExecution;
        [XafDisplayName("Pre Execution Job"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        public bool IsPreExecution
        {
            get { return _IsPreExecution; }
            set
            {
                if (_IsPreExecution != value)
                {
                    _IsPreExecution = value;
                    OnPropertyChanged("IsPreExecution");
                }
            }
        }

        private bool _IsExecution;
        [XafDisplayName("Execution Job"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        public bool IsExecution
        {
            get { return _IsExecution; }
            set
            {
                if (_IsExecution != value)
                {
                    _IsExecution = value;
                    OnPropertyChanged("IsExecution");
                }
            }
        }

        private bool _IsPostExecution;
        [XafDisplayName("Post Execution Job"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        public bool IsPostExecution
        {
            get { return _IsPostExecution; }
            set
            {
                if (_IsPostExecution != value)
                {
                    _IsPostExecution = value;
                    OnPropertyChanged("IsPostExecution");
                }
            }
        }

        private bool _IsClosure;
        [XafDisplayName("Close Job"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
