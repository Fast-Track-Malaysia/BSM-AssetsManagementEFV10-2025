...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [XafDisplayName("Equipment Attachment")]
    ...
    public class EquipmentAttachments : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public EquipmentAttachments()
        {
