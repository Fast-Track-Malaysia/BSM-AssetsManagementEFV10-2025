...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    public class Technicians : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public Technicians()
        {
        ...
        [XafDisplayName("Technician Code"), ToolTip("Enter Text")]
        [RuleUniqueValue]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        ...
        [XafDisplayName("Technician Name"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleRequiredField(DefaultContexts.Save)]
