...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    public class SCECategories : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public SCECategories()
        {
            // In the constructor, initialize collection properties, e.g.: 
            this.SCESubCateogry = new List<SCESubCategories>();
        }
        ...
        [XafDisplayName("SCE Category Code"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleUniqueValue]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        [XafDisplayName("SCE Category Name"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        public virtual Criticalities Criticality { get; set; }
        ...
        // Collection property:
        public virtual IList<SCESubCategories> SCESubCateogry { get; set; }
        ...
        void IXafEntityObject.OnCreated()
        {
            ...
            IsNew = true;
            BoShortName = "";
            Criticality = objectSpace.FindObject<Criticalities>(new BinaryOperator("BoCode", "SCE", BinaryOperatorType.Equal));
        }
