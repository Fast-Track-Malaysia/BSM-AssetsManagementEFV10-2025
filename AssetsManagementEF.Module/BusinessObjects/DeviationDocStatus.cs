...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [XafDisplayName("Deviation Doc Status")]
    //[DefaultListViewOptions(MasterDetailMode.ListViewOnly, false, NewItemRowPosition.None)]
    // Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    [Appearance("HideNew", AppearanceItemType = "Action", TargetItems = "New", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    ...
    public class DeviationDocStatus : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public DeviationDocStatus()
        {
        ...
        private DeviationStatus _DocStatus;
        [XafDisplayName("Document Status"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [Index(10), VisibleInListView(true), VisibleInDetailView(true), VisibleInLookupListView(false)]
        [Appearance("DocStatus", Enabled = false)]
        public virtual DeviationStatus DocStatus
        {
        ...
        [XafDisplayName("Document Remarks"), ToolTip("Enter Text")]
        ...
        public string DocRemarks
        {
            ...
            set
            {
                if (_DocRemarks != value)
                {
                    _DocRemarks = value;
                    OnPropertyChanged("DocRemarks");
                }
            }
        }
