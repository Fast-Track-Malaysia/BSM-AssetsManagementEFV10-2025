...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    public class EqClassDocs : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public EqClassDocs()
        {
        ...
        [Appearance("EqClass", Enabled = false)]
        public virtual EqClasses EqClass { get; set; }
