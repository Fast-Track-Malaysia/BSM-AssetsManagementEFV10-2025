...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    public class SCESubCategories : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public SCESubCategories()
        {
        ...
        [XafDisplayName("SCE Sub Category Code"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        [RuleUniqueValue]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        [XafDisplayName("SCE Sub Category Name"), ToolTip("Enter Text")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        ...
        [Index(11), VisibleInDetailView(false), VisibleInListView(false), VisibleInLookupListView(true)]
        public virtual SCECategories SCECategory { get; set; }
