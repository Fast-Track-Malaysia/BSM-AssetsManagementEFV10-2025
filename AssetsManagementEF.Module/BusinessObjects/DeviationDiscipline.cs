...
namespace AssetsManagementEF.Module.BusinessObjects
{
    ...
    [XafDisplayName("Deviation Discipline")]
    ...
    public class DeviationDiscipline : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public DeviationDiscipline()
        {
