...
namespace AssetsManagementEF.Web {
    ...
    public partial class AssetsManagementEFAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private AssetsManagementEF.Module.AssetsManagementEFModule module3;
        private AssetsManagementEF.Module.Web.AssetsManagementEFAspNetModule module4;
        ...
        static AssetsManagementEFAspNetApplication() {
        ...
        #endregion
        public AssetsManagementEFAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        protected override void CreateDefaultObjectSpaceProvider(CreateCustomObjectSpaceProviderEventArgs args) {
            if(args.Connection != null) {
                args.ObjectSpaceProviders.Add(new EFObjectSpaceProvider(typeof(AssetsManagementEFDbContext), TypesInfo, null, (DbConnection)args.Connection));
            }
            else {
                args.ObjectSpaceProviders.Add(new EFObjectSpaceProvider(typeof(AssetsManagementEFDbContext), TypesInfo, null, args.ConnectionString));
            }
            args.ObjectSpaceProviders.Add(new NonPersistentObjectSpaceProvider(TypesInfo, null));
        }
        private void AssetsManagementEFAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new AssetsManagementEF.Module.AssetsManagementEFModule();
            this.module4 = new AssetsManagementEF.Module.Web.AssetsManagementEFAspNetModule();
            ...
            this.securityStrategyComplex1.UserType = typeof(AssetsManagementEF.Module.BusinessObjects.SystemUsers);
            // 
            ...
            // 
            // AssetsManagementEFAspNetApplication
            // 
            this.ApplicationName = "AssetsManagementEF";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.AssetsManagementEFAspNetApplication_DatabaseVersionMismatch);
