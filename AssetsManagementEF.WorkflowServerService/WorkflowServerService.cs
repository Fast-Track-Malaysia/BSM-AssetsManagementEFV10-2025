...
namespace AssetsManagementEF.WorkflowServerService {
    public partial class AssetsManagementEFWorkflowServer  : System.ServiceProcess.ServiceBase {
        private WorkflowServer server;
        protected override void OnStart(string[] args) {
            if(server == null) {
                ServerApplication serverApplication = new ServerApplication();
                serverApplication.ApplicationName = "AssetsManagementEF";
                ...
                serverApplication.Modules.Add(new AssetsManagementEF.Module.AssetsManagementEFModule());
                serverApplication.Modules.Add(new AssetsManagementEF.Module.Win.AssetsManagementEFWindowsFormsModule());
                serverApplication.Modules.Add(new AssetsManagementEF.Module.Web.AssetsManagementEFAspNetModule());
        ...
        public AssetsManagementEFWorkflowServer() {
            InitializeComponent();
        }
    }
}
